...
class Form extends Component {
  ...
  handle_main_radio_2() {
    ...
    setTimeout(() => { document.getElementById('main2_option').style.overflow = 'visible'; }, 190);
    document.getElementById('salary_option').style.height = '0';
  ...
  handle_calendar(date) {
    const tmp = `${date.getFullYear()}-${date.getMonth() < 9 ? '0' : ''}${date.getMonth() + 1}-${date.getDate() < 10 ? '0' : ''}${date.getDate()}`;
    ...
    return (
      <div className="Body" onClick={this.toggle_calendar} onMouseMove={this.zzz}>
        ...
        <div className="profile">
            ...
            <table className="profile_table">
              <tbody>
                ...
                <tr>
                  ...
                  <td className="show_2"><div className="div_ca"><input className="date_input" id="date_input" type="date" value={this.state.pend} /><div className="calendar" id="calendar"><Calendar onChange={this.handle_calendar.bind(this)} /></div></div></td>
                </tr>
              </tbody>
            </table>
          ...
          <Scoring ref="child" scrollAnimation={this.scrollanimation} score={this.state.score} state="2" setMain={this.setMain.bind(this)} setMainCheck1={this.handle_main_radio_1} setMainCheck2={this.handle_main_radio_2} level="1" type="per" editable />
              ...
              <div className="result-table">
                <table className="grid-res">
                  <tbody>
                    ...
                    <tr>
                      <td colSpan="1" />
                      <td colSpan="5"><input id="main1" type="radio" name="main_option" onClick={this.handle_main_radio_1} checked={this.state.passPro} />Pass probationary period. Effective date on</td>
                      <td colSpan="1" />
                      <td colSpan="3"><div className="div_ca"><input className="date_input" id="date_input_pass" /><div className="calendar" id="calendar1"><Calendar onChange={this.handle_calendar.bind(this)} /></div></div></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="result-table-hidden" id="main1_option">
                <table className="grid-res">
                  <tbody>
                    <tr>
                      <td colSpan="2" />
                      <td colSpan="3"><input type="radio" name="option1" id="option1_1" onClick={this.handle_radio_1} />Confirmed By Employment Conditions</td>
                      <td />
                      <td colSpan="4"> <input type="radio" name="option1" id="option1_2" onClick={this.handle_radio_2} />Adjust the Salary and Benefits</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table className="grid-res">
                  <tbody>
                    <tr className="option1_row" id="option1_row">
                      ...
                      <td><input id="base_salary"type="number" onChange={event => this.setState({ basedSalary: event.target.value })} value={this.state.basedSalary} /></td>
                      <td colSpan="2">Mobile</td>
                      <td colSpan="1"><input id="mobile" onChange={event => this.setState({ mobile: event.target.value })} value={this.state.mobile} /></td>
                      <td />
                    </tr>
                    <tr className="option1_row" id="option1_row">
                      <td colSpan="2" />
                      <td colSpan="2">Transporation Allowance</td>
                      <td><input id="transporation" type="number" onChange={event => this.setState({ transporationAllowance: event.target.value })} value={this.state.transporationAllowance} /></td>
                      <td colSpan="2">Others Allowance</td>
                      <td colSpan="1"><input id="other" type="number" onChange={event => this.setState({ otherAllowance: event.target.value })} value={this.state.otherAllowance} /></td>
                      <td />
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="result-table">
                <table className="grid-res">
                  <tbody>
                    <tr>
                      <td colSpan="1" />
                      <td colSpan="5"><input id="main2" type="radio" name="main_option" onClick={this.handle_main_radio_2} checked={!this.state.passPro} />This person does not pass probation period. Action to be taken </td>
                      <td colSpan="4" />
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="result-table-hidden" id="main2_option">
                <table className="grid-res">
                  <tbody>
                    <tr>
                      <td colSpan="2" />
                      <td colSpan="3"><input type="radio" name="option2" id="option2_1" onClick={this.handle_input_dis1} />Termination Effective</td>
                      <td colSpan="2"><div className="div_ca"><input id="input1" className="date_input1" /><div className="calendar" id="calendar2"><Calendar onChange={this.handle_calendar.bind(this)} /></div></div></td>
                      <td colSpan="3" />
                    </tr>
                    <tr>
                      <td colSpan="2" />
                      <td colSpan="3"><input type="radio" name="option2" id="option2_2" onClick={this.handle_input_dis2} />Continued probation untill</td>
                      <td colSpan="2" ><div className="div_ca"><input id="input2" className="date_input2" /><div className="calendar" id="calendar3"><Calendar onChange={this.handle_calendar.bind(this)} /></div></div></td>
                      <td colSpan="3" />
                    </tr>
                  </tbody>
                </table>
              ...
              <div id="kkk">
                <table className="grid">
                  <tbody>
                    ...
                    <tr>
                      <th><div className="div_mark" ><button className="Accept-button" id="emp-but" onClick={this.handle_accept1}>Accept</button><div className="div_mark1" id="mark1"><img src={cmark} className="mark" /></div></div></th>
                      <th><div className="div_mark" ><button className="Accept-button" id="sup-but" onClick={this.handle_accept2}>Accept</button><div className="div_mark2" id="mark2"><img src={cmark} className="mark" /></div></div></th>
                      <th><div className="div_mark" ><button className="Accept-button" id="mag-but" onClick={this.handle_accept3}>Accept</button><div className="div_mark3" id="mark3"><img src={cmark} className="mark" /></div></div></th>
                    </tr>
                    <tr>
