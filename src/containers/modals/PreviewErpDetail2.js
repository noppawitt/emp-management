    ...
    case 1:
      return (
        <Table>
          ...
          <Table.Body>
            {bill.data.map((i, index) => (
              <Table.Row >
                <Table.Cell>{index + 1}</Table.Cell>
                <Table.Cell>{i.field1}</Table.Cell>
                <Table.Cell>{i.field2}</Table.Cell>
                <Table.Cell>{i.field3}</Table.Cell>
                <Table.Cell textAlign="right"> <NumberFormat value={i.field4} displayType="text" thousandSeparator decimalScale="2" fixedDecimalScale /> </Table.Cell>
              </Table.Row>
            ))}
          </Table.Body>
          <Table.Footer>
          ...
          <Table.Body>
            {bill.data.map(i => (
              <Table.Row >
                ...
                <Table.Cell>{i.field3}</Table.Cell>
                <Table.Cell textAlign="right" > <NumberFormat value={i.field4} displayType="text" thousandSeparator decimalScale="2" fixedDecimalScale /> </Table.Cell>
                <Table.Cell>{i.field5}</Table.Cell>
              </Table.Row>
            ))}
          </Table.Body>
          <Table.Footer>
...
const PreviewErpDetail2 = (e) => {
  switch (e.bill.typeId) {
    case 1: {
      let sum = 0;
      ...
      return (
        <div>
          <Segment size="large">
            <Header icon="money" content={headerContent[e.bill.typeId - 1]} />
            <Modal.Content>
              {table(e.bill, sum)}
              <Segment>
                {note[e.bill.typeId - 1]}
              </Segment>
            </Modal.Content>
          </Segment>
        </div>
    ...
    default:
      return (
        <div>
          default PreviewErpDetail2
        </div>
      );
  }
};

PreviewErpDetail2.propTypes = {
...
export default connect(null, null)(PreviewErpDetail2);
